...
public class Messenger
{
    ...
    private static final String prefix = "[Mob Arena]: ";
    ...
    public static boolean tell(CommandSender p, String msg) {
        ...
        p.sendMessage(ChatColor.DARK_GRAY + "[" + ChatColor.DARK_AQUA + "Mob Arena" + ChatColor.DARK_GRAY + "]: " + ChatColor.RESET + ChatColor.GRAY + msg);
        return true;
    }
